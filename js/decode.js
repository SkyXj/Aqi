...
CryptoJS.mode.ECB = function() {
    ...
    r = r.AES = x.extend({
        _7: function() {
            ...
            e = c.words,
            a = c.sigBytes / 4,
            c = 4 * ((this._26 = a + 6) + 1), b = this._32 = [], h = 0; h < c; h++) if (h < a) b[h] = e[h];
            else {
                var d = b[h - 1];
...
var aes_server_key = "tGFsbXNwewZlcg==";
var aes_server_iv = "w9VydmVswewexbQ==";
var aes_client_key = "WksdsdflFweFZ==";
var aes_client_iv = "klsfw9nsp=";
var des_key = "ssfefwksdjskdsj==";
var des_iv = "skzlkpoi=";
...
function getParamxj(city){
    var object = {};
    object['city'] = city;
    var method = 'GETDATA';
    return getParam(method,object);
}

function getParamAqi(city,type,startTime,endTime){
...
function getServerData(method, object, callback, period) {
    var key = hex_md5(method + JSON.stringify(object));
    var data = getDataFromLocalStorage(key, period);
    if (!data) {
